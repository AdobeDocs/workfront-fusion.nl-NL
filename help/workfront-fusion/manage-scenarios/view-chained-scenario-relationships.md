---
title: Verwante scenario-relaties weergeven
...
# Verbonden scenario-relaties weergeven en beheren
...
## Een kaart met geketende relaties weergeven
...
Om de relatiekaart voor een geketend scenario te bekijken:
...
1. (Optioneel) Klik op het scenario om rechtstreeks naar een ander scenario van de kaart te gaan.
   ...
   Het aangeklikte scenario opent in een ander venster.
1. (Facultatief) om tussen horizontale en verticale meningen van de kaart te schakelen, klik **Horizontaal** of **Verticaal** dichtbij het hoger-recht van de pagina van de Details van het Scenario.
1. (Optioneel) Als u een vereenvoudigde weergave van de kaart wilt zien, controleert u de rechterbenedenhoek van de pagina.

   Dit kan handig zijn als uw ketenkaart groot of complex is.
