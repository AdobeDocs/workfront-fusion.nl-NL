   ...
   <table style="table-layout:auto"> 
     ...
     <tbody> 
      ...
      <tr> 
       ...
       <td>Voer uw API-sleutel voor [!DNL Split.io] in.<p>Voor meer informatie over [!DNL Split.io] API sleutels, zie <a href="https://help.split.io/hc/en-us/articles/360019916211-API-keys"> API sleutels </a> in de [!DNL Split.io] documentatie.</p></td> 
      </tr> 
     </tbody> 
    </table>
