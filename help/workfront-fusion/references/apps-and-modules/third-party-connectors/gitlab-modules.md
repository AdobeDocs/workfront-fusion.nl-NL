...
Voor informatie over gebieden, zie [ van de Lijst alle fragmentnota&#39;s ](https://docs.gitlab.com/ee/api/notes.html#list-all-snippet-notes) in de [!DNL GitLab] documentatie.
