...
1. Als u de prioriteit voor een webhaak wilt instellen, klikt u op het vervolgkeuzemenu in de kolom Prioriteit en selecteert u de nieuwe prioriteit.

   Webhooks met een hogere prioriteit worden eerst afgehandeld, wat nuttig kan zijn als een arbeidersgroep veel automatiseringen heeft die concurreren om bronnen.
...
1. Om gebeurtenisabonnementen te bekijken verbonden aan een webhaak van Workfront, controleer het vakje naast webhaak en selecteer **tonen Details** bij de bodem van de pagina.

   >[!NOTE]
   >
   > Abonnementsgegevens voor gebeurtenissen zijn alleen beschikbaar voor Workfront-websites die zijn gemaakt met de nieuwe Workfront-connector. De details van Webhaak zijn momenteel niet beschikbaar voor andere schakelaars.
