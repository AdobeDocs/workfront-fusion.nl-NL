...
## Scenario Debugger nu beschikbaar in de Adobe Unified Experience

We hebben Scenario Debugger beschikbaar gesteld als onderdeel van het Fusion Devtool in de Adobe Unified Experience. Nu, kunnen de gebruikers die tot Fusie door Adobe toegang hebben Foutopsporing gebruiken om complexe scenario&#39;s problemen op te lossen. Debugger toont de geschiedenis van de scenario looppas en laat u toe om modules door hun naam of identiteitskaart te zoeken.

Eerder was Scenario Debugger beschikbaar slechts aan gebruikers in de klassieke ervaring van de Fusie.

Voor informatie over hoe te om debugger van het Scenario te gebruiken, zie [&#x200B; Debugger van het 0&rbrace; Scenario.](/help/workfront-fusion/manage-scenarios/debug-a-scenario.md#scenario-debugger)
