...
* Workfront naar Jira: Wijzigingen in Workfront-kwestie naar JIRA-kwestie
* Workfront naar Jira: Maak opmerkingen in JIRA wanneer u een nieuwe notitie maakt over Workfront-taak of -uitgave
* Workfront naar Jira: Maak in JIRA opmerkingen over verwijderde notitie over Workfront-taak of -uitgave
* Workfront naar Jira: Opmerking maken in JIRA wanneer nieuw document wordt gemaakt over Workfront-taak of -uitgave
* Workfront naar Jira: Maak in JIRA opmerkingen over verwijderd document over Workfront-taak of -uitgave
...
#### Wijs aangepaste velden toe in Jira.
...
+++**breid zich aan meningsinstructies voor het vormen Scenario 4 uit: De Veranderingen van WF-aan-Jira (Kwesties)**
...
1. Voeg in de eerste module een webhaak toe.
1. Selecteer in het veld Verbinding de Workfront-verbinding die de referenties voor systeemintegratie gebruikt.
1. Op het **gebied van het Type van Verslag**, uitgezochte `??`.
1. Op het **gebied van de Staat**, uitgezochte `New state`.
1. Vorm de filter met de volgende verrichtingen, gebruikend **en** optie:

   | Veld | Operator | Waarde |
   |---|---|---|
   | (Updates over problemen) |  |  |
   | assignedToID | Gelijk | Voer de Workfront-id van de gebruiker System Integration in |
   | projectID | Gelijk | Voer de id in van het project of de projecten die de webhaak moet bekijken. |
   | WF-id | Exists |  |
...
### Scenario 5: Nieuwe nota&#39;s WF-aan-Jira (Taken en Kwesties)

+++**breid aan meningsinstructies voor het vormen Scenario 5 uit: WF-aan-Jira Nieuwe nota&#39;s (Taken en Kwesties)**
...
### Scenario 6: WF-aan-Jira verwijdert nota&#39;s (Taken en Kwesties)

+++**breid zich aan meningsinstructies voor het vormen Scenario 6 uit :WF-to-Jira verwijdert nota&#39;s (Taken en Kwesties)**
...
### Scenario 7: Nieuwe Bijlagen WF-aan-Jira (Taken en Kwesties)

+++**breid aan meningsinstructies voor het vormen scenario 7 uit: WF-aan-Jira Nieuwe Gehechtheid (Taken en Kwesties)**
...
### Scenario 8: WF-aan-Jira verwijdert Bijlagen (Taken en Kwesties)

+++**breid aan meningsinstructies voor het vormen Scenario 8 uit: WF-aan-Jira verwijdert Gehechtheid (Taken en Kwesties)**
