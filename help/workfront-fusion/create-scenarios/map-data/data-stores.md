...
Elk team in uw organisatie kan tot 50 gegevensopslag hebben. De gecombineerde grootte van deze gegevensopslag kan niet de totale grootte van de gegevensopslag van uw organisatie overschrijden.
...
1. Wanneer u een gegevensopslagruimte maakt of bewerkt, klikt u op **[!UICONTROL Add]** naast het veld Gegevensstructuur.
...
1. Klik checkbox naast de gegevensopslag die u wilt uitgeven, dan **uitgeven** in de banner bij de bodem van het scherm klikken.
...
1. Klik checkbox naast de gegevensopslag die u wilt uitgeven, dan **doorbladeren** in de banner bij de bodem van het scherm klikken.
...
1. (Facultatief) schrap één of meerdere punten van de gegevensopslag door checkbox voor dat punt te klikken, dan het klikken **schrapt geselecteerde** of **schrapt allen** in de hoger-juiste hoek van het scherm.
1. Klik op **[!UICONTROL Save]**.
