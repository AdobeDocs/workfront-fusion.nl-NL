...
1. Om de orde van de routes te verifiëren, controleer het etiket voor elke route. Route 1 voert eerst uit, dan Route 2, etc.
...
1. (Facultatief) om een route onbruikbaar te maken, klik op de punten met de rechtermuisknop die van de router aan die route leiden, en selecteer **maak route** onbruikbaar.

   De gehandicapten routes tonen grijze punten die van de router aan de eerste module op de route leiden, en tonen a het gehandicapte routepictogram ![ Gehandicapte routepictogram ](assets/disabled-route-icon.png) op het etiket.

1. (Facultatief en voorwaardelijk) om een gehandicapte route toe te laten, klik het gehandicapte routepictogram ![ Gehandicapte routepictogram ](assets/disabled-route-icon.png) op het etiket van de route.
...
1. (Voorwaardelijk) Als de filternaam te lang is om in het label te passen, beweegt u de muisaanwijzer over het label om de volledige naam weer te geven.
...
Bij terugvalroutes wordt &quot;Fallback&quot; weergegeven op het label.
