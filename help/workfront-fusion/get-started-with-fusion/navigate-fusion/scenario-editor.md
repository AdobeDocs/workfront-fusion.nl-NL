...
| Zoeken in modules <p>![&#x200B; modules van het Onderzoek &#x200B;](assets/search-modules-icon.png)  </p> | Ga een onderzoekstermijn in om van een module de plaats te bepalen, dan de onderzoeksresultaten te klikken die aan die module moeten worden genomen. U kunt zoeken op modulenaam, id, type of toepassing. |
...
| Blauwdruk exporteren  <p>![&#x200B; het pictogram van de Vervaging van de Uitvoer &#x200B;](assets/export-blueprint-icon.png) </p> | Een blauwdruk van het huidige scenario exporteren. |
