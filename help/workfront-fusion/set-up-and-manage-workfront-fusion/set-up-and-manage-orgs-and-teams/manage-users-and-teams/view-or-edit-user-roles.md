...
### Overwegingen bij het toevoegen of wijzigen van bedrijfseigenaren

Uw organisatie kan meer dan één Eigenaar hebben.

Houd rekening met het volgende wanneer u een gebruiker toewijst aan of van een rol van eigenaar.

* Alleen een eigenaar kan de rol Eigenaar toewijzen of een andere rol toewijzen aan een huidige Eigenaar.
* Alleen beheerders kunnen worden geüpgraded naar eigenaar.
* Als er slechts één eigenaar is, kan die rol van Eigenaar niet worden veranderd of worden verwijderd.
* Als er slechts één Eigenaar is, kan die Eigenaar niet worden geschrapt als er andere gebruikers in de organisatie zijn.
* Wanneer een beheerder een rol van Eigenaar krijgt toegewezen, worden deze automatisch Admin in alle teams binnen de org.
* Wanneer een Eigenaar aan een andere rol wordt toegewezen, wordt die gebruiker automatisch een Lid van het Team in alle teams.
* Wanneer een nieuw team wordt gecreeerd, worden alle Eigenaars automatisch toegewezen als Admins van het Team.
