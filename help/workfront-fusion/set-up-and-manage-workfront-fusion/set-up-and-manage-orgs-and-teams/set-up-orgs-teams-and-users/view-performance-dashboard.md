...
>[!NOTE]
>
>Organisaties kunnen een inrichtingsaanvraag indienen voor één extra arbeiderspool (in totaal 2).

In het dashboard voor Fusieprestaties ziet u de volgende cijfers.

* Uitvoeringen die nog moeten worden verwerkt
Dit diagram toont het aantal executies die op een bepaald tijdstip moeten worden verwerkt.
* Pool Utilization
