...
Activiteitenlogboeken tonen drie maanden aan gegevens. Gegevens ouder dan 3 maanden kunnen worden geëxporteerd.
...
1. In het linkernavigatievenster, klik **Org overzicht** ![ het overzichtspictogram van de Org ](assets/org-overview-icon.png).
1. Als u momenteel niet in de organisatie bent waarvoor u het activiteitenlogboek wilt bekijken, klik de organisatienaam in de hoger-juiste hoek van het scherm en selecteer de organisatie van dropdown.
1. Klik op de tab **[!UICONTROL Activity Logs]** boven in het scherm.
